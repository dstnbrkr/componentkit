...
#import <FBComponentKit/CKTextComponent.h>

static const FBSizeRange kFlexibleSize = {{0, 0}, {320, 100}};

static const FBSizeRange kStrictSize = {{320, 100}, {320, 100}};

static const FBSizeRange kUnrestrictedSize = {};
...
@interface CKTextComponentTests : FBComponentSnapshotTestCase
...
- (void)testSimpleString
{
  ...
  FBSnapshotVerifyComponent(c, kFlexibleSize, @"");
}
...
- (void)testCenterAlignmentStrictBounds
{
  ...
  [CKTextComponent
   ...
   accessibilityContext:{ }];
  FBSnapshotVerifyComponent(c, kStrictSize, @"");
}
...
- (void)testComplexLigatures
{
  ...
  [CKTextComponent
   ...
   accessibilityContext:{ }];
  FBSnapshotVerifyComponent(c, kUnrestrictedSize, @"");
}
