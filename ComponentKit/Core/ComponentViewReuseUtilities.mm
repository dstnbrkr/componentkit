...
@interface FBComponentViewReuseInfo : NSObject
...
- (void)registerChildViewInfo:(FBComponentViewReuseInfo *)info;
- (void)didHide;
- (void)willUnhide;
...
void ViewReuseUtilities::mountingInRootView(UIView *rootView)
{
  ...
  FBComponentViewReuseInfo *info = [[FBComponentViewReuseInfo alloc] initWithView:rootView
...
void ViewReuseUtilities::createdView(UIView *view, const FBComponentViewClass &viewClass, UIView *parent)
{
  CKCAssertNil(objc_getAssociatedObject(view, &kViewReuseInfoKey),
               @"Didn't expect reuse info on just-created view %@", view);

  FBComponentViewReuseInfo *info = [[FBComponentViewReuseInfo alloc] initWithView:view
  ...
  FBComponentViewReuseInfo *parentInfo = objc_getAssociatedObject(parent, &kViewReuseInfoKey);
...
{
  FBComponentViewReuseInfo *info = objc_getAssociatedObject(view, &kViewReuseInfoKey);
...
@implementation FBComponentViewReuseInfo
{
...
- (void)didHide
{
  ...
  for (FBComponentViewReuseInfo *descendantInfo in _childViewInfos) {
