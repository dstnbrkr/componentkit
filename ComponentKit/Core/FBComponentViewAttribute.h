 ...
 */
struct FBComponentViewAttribute {
  /**
   ...
   typing FBComponentViewAttribute().
   */
  FBComponentViewAttribute(SEL setter);
  /**
   ...
   |--------|----------|-----------------------------------------------------------------------------------------------|
   */
  FBComponentViewAttribute(const std::string &ident,
   ...
   */
  static FBComponentViewAttribute LayerAttribute(SEL setter);
  ...
  bool operator==(const FBComponentViewAttribute &attr) const { return identifier == attr.identifier; };
};

namespace std {
  template<> struct hash<FBComponentViewAttribute>
  {
    size_t operator()(const FBComponentViewAttribute &attr) const
    {
...
typedef std::unordered_map<FBComponentViewAttribute, id> FBViewComponentAttributeValueMap;
...
/**
 ...
 e.g: It is currently used in FBComponentViewConfiguration, FBComponentViewConfiguration.attribute is of type
 std::unordered_map<FBComponentViewAttribute, id> (FBViewComponentAttributeValueMap). Its aggregate initialization
 constructor takes a list of std::pair<FBComponentViewAttribute, id>.
 */
typedef FBViewComponentAttributeValueMap::value_type FBComponentViewAttributeValue;
