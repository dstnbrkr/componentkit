...
/**
 ...
 - If this component has a view, creates or recycles a view by fetching one from the given MountContext, and:
   ...
   - Stores a reference back to this component in view.fb_component. (This sets up a retain cycle which must be torn
     down in -unmount.)
...
- (FB::Component::MountResult)mountInContext:(const FB::Component::MountContext &)context
                              ...
                              supercomponent:(FBComponent *)supercomponent NS_REQUIRES_SUPER;
...
/**
 ...
 - If the component has a _mountedView:
   ...
   - Clears the view's reference back to this component in fb_component.
   - Clears _mountedView.
 */
- (void)unmount;
...
/** Called by the FBComponentLifecycleManager when the component and all its children have been mounted. */
...
/** Used by FBComponentLifecycleManager to get the root component in the responder chain; don't touch this. */
