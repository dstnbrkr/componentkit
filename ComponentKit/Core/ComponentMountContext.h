...
namespace FB {
  namespace Component {
    struct MountContext {
      ...
      std::shared_ptr<FB::Component::ViewManager> viewManager;
       ...
       */
      std::shared_ptr<FB::Component::ViewManager> rootViewManager;
      /**
    ...
    struct MountResult {
      ...
      FB::Component::MountContext contextForChildren;
    };
  }
}
