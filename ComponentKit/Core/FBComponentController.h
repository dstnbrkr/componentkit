...
@interface FBComponentController : NSObject
...
/** Corresponds to -willDisplayCell:for{Row|Item}AtIndexPath:. Not invoked for FBComponentHostingViews. */
- (void)componentTreeWillAppear NS_REQUIRES_SUPER;

/** Corresponds to -didEndDisplayingCell:for{Row|Item}AtIndexPath:. Not invoked for FBComponentHostingViews. */
- (void)componentTreeDidDisappear NS_REQUIRES_SUPER;

/** The current version of the component. */
@property (nonatomic, weak, readonly) FBComponent *component;
