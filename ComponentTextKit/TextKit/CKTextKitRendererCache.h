...
#import <FBComponentKit/CKCacheImpl.h>
  ...
  namespace TextKit {
    ...
    namespace Renderer {
      ...
      struct Key {
        ...
        const Key(CKTextKitAttributes a, CGSize cs) : attributes(a), constrainedSize(cs) {
          // Precompute hash to avoid paying cost every time getHash is called.
          NSUInteger subhashes[] = {
            attributes.hash(),
            CKCGFloatHash(constrainedSize.width),
            CKCGFloatHash(constrainedSize.height)
          };
